...
#    parser.add_argument('--train', help='Path for/to the generated data. GPL will first check this path for a `corpus.jsonl` file for the (sole) data input of the whole pipeline. If an empty folder is indicated, query generation and hard-negative mining will be run automatically; one can also use a BeIR-QGen format data folder to start and skip the query generation.')
    ...
    parser.add_argument('--do_evaluation', type=bool, default=False, help='Wether to do the evaluation (after training)')
    ...
    parser.add_argument('--use_amp', type=bool, default=False, help='Whether to use half precision')
    ...
    parser.add_argument('--use_train_qrels', type=bool, default=False)
