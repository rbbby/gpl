...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_evaluation', default=False, help='Wether to do the evaluation (after training)')
    ...
    parser.add_argument('--use_amp', default=False, help='Whether to use half precision')
    ...
    parser.add_argument('--use_train_qrels', default=False)
